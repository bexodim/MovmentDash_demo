  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved level as @level" do
        ...
        post :create, {:level => { "number" => "invalid value" }}, valid_session
        assigns(:level).should be_a_new(Level)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested level" do
        ...
        Level.any_instance.should_receive(:update_attributes).with({ "number" => "1" })
        put :update, {:id => level.to_param, :level => { "number" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the level as @level" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Level.any_instance.stub(:save).and_return(false)
        put :update, {:id => level.to_param, :level => { "number" => "invalid value" }}, valid_session
        assigns(:level).should eq(level)
      end
